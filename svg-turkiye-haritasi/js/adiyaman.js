...
var turkeyText = document.getElementById("adiyaman");
var arrowLine = null;
var arrowLine2 = null;
var arrowLine3 = null;
var arrowLine4 = null;
...
turkeyText.addEventListener("click", function(event) {
    if (!clicked) {
        ...
        var adiyamanX = 650;var adiyamanY= 310;
        ...
        text58.textContent = "530";

        arrowLine59 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine59.setAttribute("x1", adiyamanX);
        arrowLine59.setAttribute("y1", adiyamanY);
        ...
        text60.textContent = "150";

        arrowLine61 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine61.setAttribute("x1", adiyamanX);
        arrowLine61.setAttribute("y1", adiyamanY);
        arrowLine61.setAttribute("x2", urfaX);
        arrowLine61.setAttribute("y2", urfaY);
        ...
        text61.setAttribute("x", 720);
        text61.setAttribute("y", 355);
        text61.setAttribute("fill", "aqua");
        text61.setAttribute("font-size","12px");
        text61.textContent = "4500";

        arrowLine62 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine62.setAttribute("x1", adiyamanX);
        arrowLine62.setAttribute("y1", adiyamanY);
    ...
    &&text55&&text56&&text57&&text58&&text59&&text60&&text61&&text62&&text63&&text64&&text65&&text66) {
            arrowLine.remove();
            arrowLine2.remove();
            arrowLine3.remove();
            arrowLine4.remove();
