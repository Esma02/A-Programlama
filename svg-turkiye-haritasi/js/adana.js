...
turkeyText.addEventListener("click", function(event) {
    if (!clicked) {
        ...
        text6.textContent = "12";


    
        arrowLine7 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine7.setAttribute("x1", adanaX);
        arrowLine7.setAttribute("y1", adanaY);
        ...
        text13.textContent = "150";


        arrowLine14 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine14.setAttribute("x1", adanaX);
        arrowLine14.setAttribute("y1", adanaY);
        ...
        text15.textContent = "150";



        arrowLine16 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine16.setAttribute("x1", adanaX);
        arrowLine16.setAttribute("y1", adanaY);
        ...
        text23.textContent = "679";



        arrowLine24 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine24.setAttribute("x1", adanaX);
        arrowLine24.setAttribute("y1", adanaY);
        ...
        text24.textContent = "180";




        arrowLine25 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine25.setAttribute("x1", adanaX);
        arrowLine25.setAttribute("y1", adanaY);
        ...
        text37.textContent = "366";



        arrowLine38 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine38.setAttribute("x1", adanaX);
        arrowLine38.setAttribute("y1", adanaY);
        ...
        text38.textContent = "130";



        arrowLine39 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine39.setAttribute("x1", adanaX);
        arrowLine39.setAttribute("y1", adanaY);
